...
void display_sp_descriptor_qr(void)
{
    ...
    // NOTE: no help url, as the xpub export page does not cover this descriptor
    if (!display_bcur_bytes_qr(message, 3, (const uint8_t*)descriptor, strlen(descriptor), NULL)) {
