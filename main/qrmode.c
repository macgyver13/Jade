...
void display_sp_descriptor_qr(void)
{
    ...
    // TODO: this url needs Blockstream approval, and confirmation that the page exists
    if (!display_bcur_bytes_qr(message, 3, (const uint8_t*)descriptor, strlen(descriptor), "blkstrm.com/spscan")) {
